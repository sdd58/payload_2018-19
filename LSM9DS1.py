...
class LSM9DS1:
    ...
    def begin(self):
        ...
        # of each sensor. That's what these functions are for.
    ...
    def calibrate(self, autoCalc):
        ...
        for ii in samples:
            ...
            self.aBiasRawTemp[2] += self.az - \
                (1 / self.aRes)  # Assumes sensor facing up!
    ...
    def readGyro(self):
        ...
        temp = self.I2Cbus.read_i2c_block_data(self.xgAddr, OUT_X_L_G, 6)
    ...
    def setGyroScale(self, gScl):
        ctrl1RegValue = self.I2Cbus.read_byte_data(
            self.xgAddr, CTRL_REG1_G) & 0xE7
